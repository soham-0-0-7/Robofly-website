// filepath: c:\Users\soham\OneDrive\Desktop\Robofly - internship\website\robofly-website\src\app\robofly-admin\dashboard\updateProduct\[id]\page.tsx
"use client";
...
export default function UpdateProductPage() {
  ...
  useEffect(() => {
    const checkSessionAndFetchProduct = async () => {
      try {
        ...
        if (!sessionData.user.permissions?.product?.updateProducts) {
          setSessionError(
            "You don't have permission to update products. Redirecting to dashboard..."
          );
        ...
        if (!productResponse.ok) {
          setSessionError(`Failed to fetch product data: ${productData.error}`);
          setTimeout(() => router.push("/robofly-admin/dashboard"), 2000);
          return;
        }
        ...
        setSessionError(
          "Failed to verify your session or fetch product data. Redirecting to login..."
        );
        setTimeout(() => router.push("/robofly-admin"), 2000);
      } finally {
        setLoading(false);
          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <div className="px-6 py-4 bg-blue-50 border-b">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Update details for product ID: {productId}
              </p>
            </div>
