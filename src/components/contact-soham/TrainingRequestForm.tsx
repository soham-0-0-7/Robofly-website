...
const TrainingRequestForm = () => (
  ...
  >
    ...
    <div>
      <label style={labelStyle}>What course are you interested in? *</label>
      <input required placeholder="Course of Interest" style={inputStyle} />
    </div>
    <div>
      <label style={labelStyle}>Why do you want to join this training program?</label>
      <textarea placeholder="Why do you want to join this training program?" style={inputStyle} rows={3} />
    </div>
