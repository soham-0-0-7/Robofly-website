...
export default function RecognitionSection() {
  ...
  const supportedBy = [
    { src: '/images/Recognition_Support/aic bansthali.jpeg.jpg', alt: 'AIC Banasthali' },
    { src: '/images/Recognition_Support/iit mandi.png', alt: 'IIT Mandi Catalyst' },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Recognized Logos */}
      <div ref={recognitionRef} className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-4xl mx-auto mb-10">
