...
export default function SixthServiceForm(): JSX.Element {
  const [form, setForm] = useState<FormData>({
    fullName: '', organizationName: '', email: '', phone: '', regionName: '',
    affectedArea: '', analysisRequired: '', preferredSensor: '', previousSurveys: '',
    customParameters: '', desiredTimeline: '', notes: ''
  });
  ...
  return (
    <div className="flex justify-center py-10 px-4">
      <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl w-full rounded-xl bg-white p-8">
        <h2 className="text-2xl font-bold text-center mb-8">Post-Fire Biodiversity & Impact Analysis Inquiry Form</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-medium mb-1">
              Affected Forest / Region Area (sq. km) <span className="text-red-600">*</span>
            </label>
            <input
              name="affectedArea"
              required
