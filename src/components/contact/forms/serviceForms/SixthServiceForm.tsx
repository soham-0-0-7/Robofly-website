...
"use client";
// Post-Wildfire Biodiversity & Impact Assessment
...
export default function SixthServiceForm(): JSX.Element {
  ...
  const submitFormToDatabase = async () => {
    try {
      ...
      setErrors({});
      alert("Post-wildfire assessment inquiry submitted successfully!");
      ...
      <div className="flex justify-center py-10 px-4">
        ...
        >
          <h2 className="text-2xl font-bold text-center mb-4">
            Post-Wildfire Biodiversity & Impact Assessment Inquiry Form
          </h2>
          ...
          <div>
            <label className="block font-medium mb-1">
              Fire-Affected Area/Location Name{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block font-medium mb-1">
                Fire Incident Date <span className="text-red-600">*</span>
              </label>
              <input
                name="fireIncidentDate"
                required
                type="date"
                max={today}
                value={form.fireIncidentDate}
                onChange={handleChange}
                className="input"
              />
            </div>
            ...
            <div>
              <label className="block font-medium mb-1">
                Fire Duration (days) <span className="text-red-600">*</span>
              </label>
              <input
                name="fireDuration"
                required
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium mb-1">
                Pre-Fire Ecosystem Type <span className="text-red-600">*</span>
              </label>
              <select
                name="ecosystemType"
                required
            ...
            <div>
              <label className="block font-medium mb-1">
                Assessment Type Required <span className="text-red-600">*</span>
              </label>
              <select
                name="assessmentType"
                required
          ...
          <div>
            <label className="block font-medium mb-1">
              Specific Assessment Concerns & Objectives{" "}
              <span className="text-red-600">*</span>
            </label>
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Describe specific species, habitats, or environmental factors of concern, assessment objectives..."
          ...
          <div>
            <label className="block font-medium mb-1">
              Pre-Fire Baseline Data Availability
            </label>
            <textarea
              name="baselineData"
              rows={3}
              value={form.baselineData}
              onChange={handleChange}
              className="input"
              placeholder="Describe any pre-fire data, surveys, or studies available for comparison..."
          ...
          <div>
            <label className="block font-medium mb-1">
              Assessment Urgency <span className="text-red-600">*</span>
            </label>
            <select
              name="urgency"
              required
            ...
            >
              ...
              <option value="High (Within 3 months)">
                High (Within 3 months)
              </option>
              <option value="Medium (Within 6 months)">
                Medium (Within 6 months)
              </option>
              <option value="Low (Within 1 year)">Low (Within 1 year)</option>
            </select>
          </div>

          <div>
            <label className="block font-medium mb-1">
              Site Access Conditions & Constraints{" "}
              <span className="text-red-600">*</span>
            </label>
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Describe current site conditions, safety concerns, access routes, permits needed..."
              maxLength={MAX_LENGTHS.description}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Any additional context, special equipment needs, collaboration requirements, or other considerations..."
          ...
          <input
            type="hidden"
            name="querytype"
            value="service-post-wildfire-assessment"
          />
