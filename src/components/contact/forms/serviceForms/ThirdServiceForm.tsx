...
"use client";
// Dam Surveillance and Structural Analysis
...
export default function ThirdServiceForm(): JSX.Element {
  ...
  const submitFormToDatabase = async () => {
    try {
      ...
      setErrors({});
      alert("Dam surveillance inquiry submitted successfully!");
      ...
      <div className="flex justify-center py-10 px-4">
        ...
        >
          <h2 className="text-2xl font-bold text-center mb-4">
            Dam Surveillance and Structural Analysis Inquiry Form
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block font-medium mb-1">
                Organization/Agency <span className="text-red-600">*</span>
              </label>
              <input
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium mb-1">
                Dam Name <span className="text-red-600">*</span>
              </label>
              <input
                name="damName"
                required
            ...
            <div>
              <label className="block font-medium mb-1">
                Dam Type <span className="text-red-600">*</span>
              </label>
              <select
                name="damType"
                required
                ...
                className="input"
              >
                <option value="">Select Dam Type</option>
                {damTypes.map((type) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium mb-1">
                Dam Height (in meters) <span className="text-red-600">*</span>
              </label>
              <input
                name="damHeight"
                required
          ...
          <div>
            <label className="block font-medium mb-1">
              Specific Concerns or Issues Observed{" "}
              <span className="text-red-600">*</span>
            </label>
            <textarea
              name="concernsObserved"
              required
              rows={4}
              value={form.concernsObserved}
              onChange={handleChange}
              className="input"
              placeholder="Describe any visible cracks, seepage, settlement, or other structural concerns..."
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Describe access routes, restrictions, permits required, etc."
          ...
          <input
            type="hidden"
            name="querytype"
            value="service-dam-surveillance"
          />
