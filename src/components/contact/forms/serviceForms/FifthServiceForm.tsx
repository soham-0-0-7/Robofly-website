...
export default function FifthServiceForm(): JSX.Element {
  const [form, setForm] = useState<FormData>({
    fullName: '', organizationName: '', email: '', phone: '', regionName: '', forestArea: '',
    servicesRequired: '', pastFireHistory: '', availableGISData: '', needAIMLModels: '',
    preferredDeliveryFormat: '', timelineToDeploy: '', governmentPermits: '', additionalNeeds: ''
  });
  ...
  <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl w-full rounded-xl bg-white p-0">
      <h2 className="text-2xl font-bold text-center mb-4">Forest Fire Eradication System Inquiry Form</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-medium mb-1">
              Organization/Department Name <span className="text-red-600">*</span>
            </label>
            <input
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-medium mb-1">
              Forest / Region Area (sq. km) <span className="text-red-600">*</span>
            </label>
            <input
              name="forestArea"
              required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            >
              ...
              <option value="Fire Spread Risk Modeling">Fire Spread Risk Modeling</option>
          ...
          <div>
            <label className="block font-medium mb-1">
              Past Fire History Availability <span className="text-red-600">*</span>
            </label>
            <select
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-medium mb-1">
              Need for AI/ML Risk Models? <span className="text-red-600">*</span>
            </label>
            <select
              name="needAIMLModels"
              required
        ...
        <div>
          <label className="block font-medium mb-1">
            Government Permits or Clearances <span className="text-red-600">*</span>
          </label>
          <select
