...
interface FormData {
  ...
  inspectionServicesOther: string;
  structureAge: string;
...
const inspectionServiceOptions = [
  "Visual Inspection",
  "Thermal Imaging",
...
export default function FourthServiceForm(): JSX.Element {
  ...
  const handleCheckboxChange = (value: string) => {
    setForm((prev) => {
      const current = prev.inspectionServices;
      return current.includes(value)
        ? { ...prev, inspectionServices: current.filter((v) => v !== value) }
        : { ...prev, inspectionServices: [...current, value] };
    });
  };
  ...
  const submitFormToDatabase = async () => {
    try {
      ...
      setErrors({});
      alert("Industrial inspection inquiry submitted successfully!");
      ...
      <div className="flex justify-center py-10 px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block font-medium mb-1">
                Facility/Structure Name <span className="text-red-600">*</span>
              </label>
              <input
                name="facilityName"
                required
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2">
              {inspectionServiceOptions.map((service) => (
                <label key={service} className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    checked={form.inspectionServices.includes(service)}
            ...
            {form.inspectionServices.includes("Other") && (
              <input
                name="inspectionServicesOther"
                type="text"
                placeholder="Please specify other services..."
                value={form.inspectionServicesOther}
                onChange={handleChange}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block font-medium mb-1">
                Last Inspection Date (if available)
              </label>
              <input
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Describe any known issues, areas of concern, or specific focus areas for inspection..."
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="input"
              placeholder="Describe access routes, safety requirements, permits needed, restricted areas, etc."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              >
                ...
                <option value="Standard Safety Protocols">
                  Standard Safety Protocols
                </option>
                <option value="Industrial Safety Standards">
                  Industrial Safety Standards
                </option>
                <option value="High-Risk Environment Protocols">
                  High-Risk Environment Protocols
                </option>
                <option value="Regulatory Compliance Required">
