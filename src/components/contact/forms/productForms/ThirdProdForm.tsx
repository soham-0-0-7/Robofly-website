...
const deliveryFrequencies = ["Daily", "Weekly", "Monthly", "On-demand"];
const terrainTypes = ["Urban", "Rural", "Mountainous", "Coastal", "Mixed"];
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="form-input"
              placeholder="Enter payload capacity in kg"
              maxLength={MAX_LENGTHS.numbers}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block font-medium mb-1">
                GPS Tracking Required? <span className="text-red-600">*</span>
              </label>
              <select
                name="gpsTracking"
                required
          ...
          <div>
            <label className="block font-medium mb-1">
              Route Terrain <span className="text-red-600">*</span>
            </label>
            <select
              name="routeTerrain"
              required
